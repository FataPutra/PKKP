...
public class LaporanNilai extends javax.swing.JFrame {
     ...
     private void baca_data()
    {
        try{
            ...
            RsNilai = stm.executeQuery("SELECT st.no_seleksi, st.nama_lengkap,st.kab_penempatan,st.point + sw.point AS total_poin FROM tertulis st JOIN wawancara sw ON st.no_seleksi = sw.no_seleksi");
